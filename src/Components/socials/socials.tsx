...
const Socials: FC<Props> = ({ theme, userInfo }) => {
  return (
    <div className="socialsContainer">
      <div className="locationAndGithub">
        <div className="locationContainer">
          <svg
            className={`locationLogo ${theme === "dark" ? "socialsDark" : ""} ${
              userInfo?.location === null ? "notAvailable" : ""
            }`}
            height="20"
            width="14"
          ...
          <p
            className={`locationName ${theme === "dark" ? "socialsDark" : ""} ${
              userInfo?.location === null ? "notAvailable" : ""
            }`}
          >
            {userInfo?.location
        ...
        <div className="githubContainer">
          <svg
            className={`linkLogo ${theme === "dark" ? "socialsDark" : ""}`}
            height="20"
            width="20"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <a
            className={`githubLink ${theme === "dark" ? "socialsDark" : ""}`}
            href={
              userInfo?.html_url ? userInfo.html_url : "https://github.blog"
            }
          >
            {userInfo?.html_url ? userInfo.html_url : "https://github.blog"}
          </a>
      ...
      <div className="twitterAndCompany">
        <div className="twitterContainer">
          <svg
            className={`twitterLogo ${theme === "dark" ? "socialsDark" : ""} ${
              !userInfo?.twitter_username || userInfo?.twitter_username === null
                ? "notAvailable"
                : ""
            }`}
            height="18"
          ...
          <p
            className={`twitterLink ${theme === "dark" ? "socialsDark" : ""} ${
              !userInfo?.twitter_username || userInfo?.twitter_username === null
                ? "notAvailable"
                : ""
            }`}
        ...
        <div className="companyContainer">
          <svg
            className={`companyLogo ${theme === "dark" ? "socialsDark" : ""} ${
          ...
          <p
            className={`companyName ${theme === "dark" ? "socialsDark" : ""} ${
              userInfo?.company || userInfo?.company !== null
                ? ""
                : "notAvailable"
            }`}
